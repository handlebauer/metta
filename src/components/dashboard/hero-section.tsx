        ...
        <div className="flex w-full min-h-[calc(100vh-4rem)]">
            <div className="container mx-auto flex items-center justify-center">
                <div className="relative w-full max-w-[580px]">
                    <div className="absolute -right-48 top-1/2 -translate-y-1/2 hidden lg:block pointer-events-none select-none">
                        <Image
                            src="/ai.png"
                    ...
                    <div className="relative z-10 flex flex-col items-center -translate-x-14">
                        <h1 className="scroll-m-20 text-4xl lg:text-5xl font-bold tracking-tight leading-[1.3] lg:leading-[1.2] text-center">
                            Support with{' '}
                            <span className="p-2 bg-purple-100 rounded-[8px] whitespace-nowrap">
                                Balance
                            </span>
                        </h1>
                        <p className="text-gray-500 text-lg mt-4 dark:text-gray-400 max-w-[500px] text-center font-medium">
                            AI efficiency with authentic human connection
                        </p>
